...
async def uploadProductImages(files, productID: int, db_pool: aioodbc.Pool):
    try:
        ...
        for file in files:
            ...
            query = "INSERT INTO productImage (productID, type, image) VALUES (?, ?, ?);"
            values = (productID, 'product', filename)
